...
import './App.css';
import abhiImage from "./Mrudhula.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Mrudhula" />
          <h3 className="name">Mrudhula</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Mrudhula</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Mrudhula</h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Nellore</h3>
            <h3> <span> Strengths : </span> Hardwork,SmartWork </h3>
            <h3> <span> Hobbies: </span> travelling, reading </h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>ratnam school</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
            <h3>Intermediate</h3>
            <h3>MPC</h3>
            <p style={{ fontSize: '20px' }}>narayana junior clg</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2021-2025</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> mrudhula.21bce9555@vitapstudent.ac.in</h3>
              <h3> <i className="fas fa-phone"></i> 7842874539 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> Nellore</h3>
            </div>
          </div>
        </div>
      </section>
